...
import { G_ as createChatChannelPlugin, Gv as projectAccountConfigWarningCollector, J_ as stripChannelTargetPrefix, Q_ as adaptScopedAccountAccessor, Rv as createAllowlistProviderOpenWarningCollector, U_ as buildChannelOutboundSessionRoute, Y_ as stripTargetKindPrefix, iv as createScopedDmSecurityResolver, nv as createScopedChannelConfigAdapter } from "./pi-embedded-BTYL55uj.js";
...
import { b as requiresExplicitMatrixDefaultAccount } from "./matrix-B19qBU9f.js";
import { r as buildTrafficStatusSummary } from "./extension-shared-CzEiSbvp.js";
import { a as getMatrixRuntime } from "./credentials-read-C82dg7Ru.js";
import { $ as updateMatrixAccountConfig, A as normalizeMatrixMessagingTarget, G as resolveMatrixEnvAuthReadiness, I as resolveDefaultMatrixAccountId, L as resolveMatrixAccount, M as resolveMatrixDirectUserId, N as resolveMatrixTargetIdentity, P as listMatrixAccountIds, R as resolveMatrixAccountConfig, j as normalizeMatrixResolvableTarget, tt as hasExplicitMatrixAccountConfig } from "./send-ErlDppBV.js";
import { i as resolveMatrixRoomConfig, n as normalizeMatrixUserId, t as normalizeMatrixAllowList } from "./allowlist-CDmlbdAB.js";
import { n as bootstrapMatrixVerification } from "./verification-CR1j0AGM.js";
import { z } from "zod";
...
const matrixMessageActions = {
	...
	handleAction: async (ctx) => {
		const { handleMatrixAction } = await import("./tool-actions.runtime-C0Zg5L2G.js");
...
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Bp10kp2s.js"), "matrixChannelRuntime");
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-BHCgM6lJ.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
