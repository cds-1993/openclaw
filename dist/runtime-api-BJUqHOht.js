...
import { c as updateLastRoute, i as readSessionUpdatedAt } from "./store-_QDcIMYk.js";
...
import { m as resolveSessionKey } from "./sessions-BwqyiEaq.js";
import { l as resolveStorePath } from "./paths-rhN9LKM_.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled } from "./commands-2T-1FAo7.js";
import { i as resolveHumanDelayConfig, t as resolveAckReaction } from "./identity-D07jLUrU.js";
import { $g as formatInboundEnvelope, $v as resolveChannelConfigWrites, B_ as mergeAllowlist, Cs as truncateSlackText, Es as editSlackMessage, Fs as removeSlackReaction, Gg as hasControlCommand, Gs as resolveSlackThreadStarter, H_ as summarizeMapping, Hg as resolveMentionGatingWithBypass, Hs as resolveSlackAttachmentContent, Js as require_dist$4, Ks as createSlackWebClient, L_ as addAllowlistUserEntriesFromConfigEntry, Lg as resolveNativeCommandSessionTargets, Ms as reactSlackMessage, Qs as require_dist$3, R_ as buildAllowlistResolutionSummary, Rs as sendMessageSlack, Ug as createChannelInboundDebouncer, Us as resolveSlackMedia, V_ as patchAllowlistUsersInConfigEntries, Vs as normalizeSlackOutboundText, Wg as shouldDebounceTextInbound, Ws as resolveSlackThreadHistory, Xs as require_eventemitter3, Ys as require_dist$5, ac as resolveSlackReplyToMode, as as recordSlackThreadParticipation, c_ as dispatchInboundMessage, cs as normalizeAllowListLower, ds as resolveSlackAllowListMatch, fs as resolveSlackUserAllowed, ic as resolveSlackAccount, is as hasSlackThreadParticipation, ls as normalizeSlackAllowOwnerEntry, oc as resolveSlackAppToken, os as allowListMatches, p_ as createReplyDispatcherWithTyping, qs as resolveSlackWebClientOptions, sc as resolveSlackBotToken, ss as normalizeAllowList, t_ as resolveEnvelopeFormatOptions, us as normalizeSlackSlug, ws as deleteSlackMessage, wt as dispatchPluginInteractiveHandler, zs as SLACK_TEXT_LIMIT } from "./pi-embedded-BTYL55uj.js";
import { t as generateSecureToken } from "./secure-random-Dgumttcn.js";
import { i as resolveAgentRoute } from "./resolve-route-jw3TrvbG.js";
import { n as resolveAgentOutboundIdentity } from "./outbound-runtime-QVIwx-7l.js";
import { S as resolveTextChunkLimit, r as chunkItems, t as withTimeout } from "./text-runtime-BXjeqyjp.js";
...
import { F as resolvePluginConversationBindingApproval, N as parsePluginBindingApprovalCustomId, T as buildPluginBindingResolvedText, s as recordInboundSession } from "./conversation-runtime-C56HP9yG.js";
import { d as upsertChannelPairingRequest } from "./pairing-store-Bh2YkvRc.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-CA9BsqQV.js";
import { c as resolvePinnedMainDmOwnerFromAllowlist, l as resolveCommandAuthorizedFromAuthorizers, n as readStoreAllowFromForDmPolicy, u as resolveControlCommandGate } from "./dm-policy-shared-ChGQzSwJ.js";
import { t as evaluateGroupRouteAccessForPolicy } from "./group-access-DbAQwRuM.js";
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-BTv3KfjW.js";
import { t as pruneMapToMaxSize } from "./map-size-8PXXQPcj.js";
import { t as createDedupeCache } from "./dedupe-CCJJrryE.js";
...
import { a as buildPendingHistoryContextFromMap, f as buildMentionRegexes, m as matchesMentionWithExplicit, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./reply-history-yYXk1ivL.js";
import { y as shouldHandleTextCommands } from "./commands-registry-ABOHrld2.js";
import { d as logInboundDrop, f as logTypingFailure, u as logAckFailure } from "./channel-feedback-mKZrhk-A.js";
import { f as computeBackoff, p as sleepWithAbort } from "./level-overrides-BtGuLyCH.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-TMkiuJ0K.js";
import { M as installRequestBodyLimitGuard } from "./webhook-ingress-BBdXea0x.js";
...
import { t as require_axios } from "./axios-CNdtDiTY.js";
import { n as normalizeSlackWebhookPath, r as registerSlackHttpHandler } from "./registry-B1vmwoRP.js";
import { n as createConnectedChannelStatusPatch } from "./gateway-runtime-Czf7LoCY.js";
import { f as createDraftStreamLoop } from "./channel-lifecycle-CGlugnkL.js";
import { n as resolveSlackChannelAllowlist, t as resolveSlackUserAllowlist } from "./resolve-users-BqfUFpQo.js";
import { t as require_jsonwebtoken } from "./jsonwebtoken-DNgNvxUe.js";
import { a as resolveSlackThreadTs, i as readSlackReplyBlocks, n as deliverReplies, t as createSlackReplyDeliveryPlan } from "./replies-D3xHCwrG.js";
...
var require_errors$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	*/
	...
	var InstallerInitializationError = class extends Error {
		constructor() {
			super(...arguments);
	...
	var GenerateInstallUrlError = class extends Error {
		constructor() {
			super(...arguments);
	...
	var MissingStateError = class extends Error {
		constructor() {
			super(...arguments);
	...
	var MissingCodeError = class extends Error {
		constructor() {
			super(...arguments);
	...
	var AuthorizationError = class extends Error {
		constructor(message, original) {
			...
			if (original !== void 0) this.original = original;
		}
	};
	exports.AuthorizationError = AuthorizationError;
}));
...
var require_callback_options = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	function defaultCallbackSuccess(installation, _options, _req, res) {
		let redirectUrl;
		if (isNotOrgInstall(installation) && installation.appId !== void 0) redirectUrl = `slack://app?team=${installation.team.id}&id=${installation.appId}`;
		else if (isOrgInstall(installation)) redirectUrl = `${installation.enterpriseUrl}manage/organization/apps/profile/${installation.appId}/workspaces/add`;
		else redirectUrl = "slack://open";
		let browserUrl = redirectUrl;
		if (isNotOrgInstall(installation)) browserUrl = `https://app.slack.com/client/${installation.team.id}`;
...
var require_file_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const node_os_1$1 = __require("node:os");
	const node_path_1$1 = __importDefault(__require("node:path"));
	var FileInstallationStore = class {
		constructor({ baseDir = `${(0, node_os_1$1.homedir)()}/.bolt-js-app-installation`, clientId, historicalDataEnabled = true } = {}) {
			this.baseDir = clientId !== void 0 ? node_path_1$1.default.join(baseDir, clientId) : baseDir;
		...
		async storeInstallation(installation, logger) {
			...
			try {
				writeToFile(node_path_1$1.default.join(installationDir, "app-latest"), installationData);
				writeToFile(node_path_1$1.default.join(installationDir, `user-${user.id}-latest`), installationData);
				if (this.historicalDataEnabled) {
					const currentUTC = Date.now();
					writeToFile(node_path_1$1.default.join(installationDir, `app-${currentUTC}`), installationData);
					writeToFile(node_path_1$1.default.join(installationDir, `user-${user.id}-${currentUTC}`), installationData);
				}
			} catch (err) {
		...
		async fetchInstallation(query, logger) {
			...
			if (logger !== void 0) logger.info(`Retrieving installation from ${installationDir} with the following query: ${JSON.stringify(query)}`);
			...
			try {
				const data = node_fs_1$1.default.readFileSync(node_path_1$1.default.join(installationDir, "app-latest"));
				const installation = JSON.parse(data.toString());
				if (query.userId && installation.user.id !== query.userId) try {
					const userData = node_fs_1$1.default.readFileSync(node_path_1$1.default.join(installationDir, `user-${query.userId}-latest`));
					if (userData !== void 0 && userData !== null) installation.user = JSON.parse(userData.toString()).user;
				} catch (_err) {
					logger === null || logger === void 0 || logger.debug(`The user-token installation for the request user (user_id: ${query.userId}) was not found.`);
		...
		async deleteInstallation(query, logger) {
			...
			if (logger !== void 0) logger.info(`Deleting installations in ${installationDir} with the following query: ${JSON.stringify(query)}`);
			let filesToDelete = [];
			if (userId === void 0) {
				const allFiles = node_fs_1$1.default.readdirSync(installationDir);
				filesToDelete = filesToDelete.concat(allFiles);
			} else {
				const userFiles = node_fs_1$1.default.readdirSync(installationDir).filter((file) => file.includes(`user-${userId}-`));
				filesToDelete = filesToDelete.concat(userFiles);
			}
			try {
				for (const filePath of filesToDelete) deleteFile(node_path_1$1.default.join(installationDir, filePath));
			} catch (err) {
		...
		getInstallationDir(enterpriseId = "", teamId = "", isEnterpriseInstall = false) {
			let installDir = node_path_1$1.default.join(this.baseDir, enterpriseId);
			if (teamId !== "" && !isEnterpriseInstall) installDir += enterpriseId !== "" ? `-${teamId}` : `${teamId}`;
			return installDir;
		}
	};
...
var require_memory_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var MemoryInstallationStore = class {
		constructor() {
			this.devDB = {};
		}
		async storeInstallation(installation, logger) {
		...
		async deleteInstallation(query, logger) {
			...
			if (query.isEnterpriseInstall && query.enterpriseId !== void 0) {
				...
				const _a = this.devDB, _b = query.enterpriseId;
				_a[_b];
				this.devDB = __rest(_a, [typeof _b === "symbol" ? _b : _b + ""]);
			} else if (query.teamId !== void 0) {
				if (logger !== void 0) logger.debug("deleting single team installation");
				const _c = this.devDB, _d = query.teamId;
				_c[_d];
				this.devDB = __rest(_c, [typeof _d === "symbol" ? _d : _d + ""]);
...
var require_logger$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const logger_1 = require_dist$3();
	var logger_2 = require_dist$3();
...
var require_clear_state_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var ClearStateStore = class {
		...
		async verifyStateParam(now, state) {
			...
			if (Math.floor((now.getTime() - generatedAt.getTime()) / 1e3) > this.stateExpirationSeconds) throw new errors_1.InvalidStateError("The state value is already expired");
...
var require_file_state_store = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var FileStateStore = class {
		constructor(args) {
			this.baseDir = args.baseDir !== void 0 ? args.baseDir : `${(0, node_os_1.homedir)()}/.bolt-js-oauth-states`;
...
var require_install_provider = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const web_api_1 = require_dist$4();
	const callback_options_1 = require_callback_options();
	const default_render_html_for_install_path_1 = __importDefault(require_default_render_html_for_install_path());
	const errors_1 = require_errors$1();
	const installation_stores_1 = require_installation_stores();
	const logger_1 = require_logger$1();
	const state_stores_1 = require_state_stores();
	/**
	* InstallProvider Class. Refer to InsallProviderOptions interface for the details of constructor arguments.
	*/
	var InstallProvider = class {
		constructor({ clientId, clientSecret, stateSecret = void 0, stateStore = void 0, stateVerification = true, legacyStateVerification = false, stateCookieName = "slack-app-oauth-state", stateCookieExpirationSeconds = 600, directInstall = false, installationStore = new installation_stores_1.MemoryInstallationStore(), installUrlOptions = void 0, renderHtmlForInstallPath = default_render_html_for_install_path_1.default, authVersion = "v2", logger = void 0, logLevel = void 0, clientOptions = {}, authorizationUrl = "https://slack.com/oauth/v2/authorize" }) {
		...
		*/
		async authorize(source) {
			...
			try {
				...
				if (queryResult === void 0 || queryResult === null) throw new Error(`Failed fetching data from the Installation Store (source: ${sourceForLogging})`);
				const authResult = {};
 ...
 /**
				...
				*/
				...
				if (authResult.botRefreshToken || authResult.userRefreshToken) {
					const currentUTCSec = Math.floor(Date.now() / 1e3);
					const tokensToRefresh = detectExpiredOrExpiringTokens(authResult, currentUTCSec);
					if (tokensToRefresh.length > 0) {
						if (queryResult.authVersion !== "v2") throw new errors_1.UnknownError("Unexpected data structure detected. The data returned by your InstallationStore#fetchInstallation() method must have \"authVersion\": \"v2\" if it has a refresh token");
						...
						} else this.logger.debug("No tokens were refreshed");
					}
				}
				return authResult;
			} catch (error) {
		...
		*/
		async refreshExpiringTokens(tokensToRefresh) {
			...
			return (await Promise.all(refreshPromises)).filter((res) => !(res instanceof Error)).map((res) => res);
		}
		...
		*/
		async handleInstallPath(req, res, options, installOptions) {
			if (installOptions === void 0 && this.installUrlOptions === void 0) throw new errors_1.GenerateInstallUrlError("To enable the built-in install path handler, you need to pass InstallURLOptions to InstallProvider. If you're using @slack/bolt, please upgrade the framework to the latest version.");
			...
			try {
				...
				if ((options === null || options === void 0 ? void 0 : options.beforeRedirection) !== void 0) shouldProceed = await options.beforeRedirection(req, res, installOptions);
				if (!shouldProceed) {
				...
				if (this.stateVerification) {
					if (this.stateStore) {
						state = await this.stateStore.generateStateParam(_installOptions, /* @__PURE__ */ new Date());
						const stateCookie = this.buildSetCookieHeaderForNewState(state);
						if (res.getHeader("Set-Cookie")) {
							const existingCookies = res.getHeader("Set-Cookie") || [];
							const allCookies = [];
							if (Array.isArray(existingCookies)) allCookies.push(...existingCookies);
					...
					} else if (this.stateStore === void 0) throw new errors_1.GenerateInstallUrlError("StateStore is not properly configured");
				}
		...
		*/
		async generateInstallUrl(options, stateVerification = true, state) {
			const slackURL = new node_url_1$2.URL(this.authorizationUrl);
			...
			const params = new node_url_1$2.URLSearchParams(`scope=${scopes}`);
			if (stateVerification) {
				let _state = state;
				if (_state === void 0) if (this.stateStore) _state = await this.stateStore.generateStateParam(options, /* @__PURE__ */ new Date());
				else throw new errors_1.InstallerInitializationError("StateStore needs to be set for generating a valid authorize URL");
		...
		*/
		async handleCallback(req, res, options, installOptions) {
			...
			try {
				...
				if (this.stateVerification) try {
					...
					if (this.stateStore) installOptions = await this.stateStore.verifyStateParam(/* @__PURE__ */ new Date(), stateInQueryString);
					else throw new errors_1.InstallerInitializationError("StateStore is not properly configured");
				} finally {
					res.setHeader("Set-Cookie", this.buildSetCookieHeaderForStateDeletion());
				}
				if (!installOptions) installOptions = { scopes: [] };
				let shouldProceed = true;
				if ((options === null || options === void 0 ? void 0 : options.beforeInstallation) !== void 0) shouldProceed = await options.beforeInstallation(installOptions, req, res);
				...
				if (this.authVersion === "v1") {
					...
					if (v1Resp.bot !== void 0) v1Installation.bot = {
						id: (await runAuthTest(v1Resp.bot.bot_access_token, this.clientOptions)).bot_id,
						scopes: ["bot"],
					...
					const currentUTC = Math.floor(Date.now() / 1e3);
					if (v2Resp.access_token !== void 0 && v2Resp.scope !== void 0 && v2Resp.bot_user_id !== void 0) {
					...
					if (v2Resp.authed_user !== void 0 && v2Resp.authed_user.access_token !== void 0) {
						if (v2Resp.is_enterprise_install && v2Installation.enterpriseUrl === void 0) v2Installation.enterpriseUrl = (await runAuthTest(v2Resp.authed_user.access_token, this.clientOptions)).url;
				...
				if ((options === null || options === void 0 ? void 0 : options.afterInstallation) !== void 0) shouldProceed = await options.afterInstallation(installation, installOptions, req, res);
				if (!shouldProceed) return;
				await this.installationStore.storeInstallation(installation, this.logger);
				if (options !== void 0 && (options.success !== void 0 || options.successAsync !== void 0)) {
					...
					if (options.successAsync !== void 0) {
				...
				if (options !== void 0 && (options.failure !== void 0 || options.failureAsync !== void 0)) {
					...
					if (options.failureAsync !== void 0) {
		...
		buildSetCookieHeaderForNewState(state) {
			return `${this.stateCookieName}=${state}; Secure; HttpOnly; Path=/; Max-Age=${this.stateCookieExpirationSeconds}`;
		}
		buildSetCookieHeaderForStateDeletion() {
			return `${this.stateCookieName}=deleted; Secure; HttpOnly; Path=/; Expires=Thu, 01 Jan 1970 00:00:00 GMT`;
		}
	};
	exports.InstallProvider = InstallProvider;
	async function runAuthTest(token, clientOptions) {
		return await new web_api_1.WebClient(token, clientOptions).auth.test({});
	}
	/**
	...
	*/
	function extractSearchParams(req) {
		const { searchParams } = new node_url_1$2.URL(req.url, `https://${req.headers.host}`);
		return searchParams;
	}
...
var require_http_errors = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	* @private
	*/
	function populateConstructorExports(exports$5, codes, HttpError) {
		codes.forEach(function forEachCode(code) {
			...
			if (CodeError) {
				exports$5[code] = CodeError;
				exports$5[name] = CodeError;
			}
		});
	}
	/**
		...
		*/
		async retrieveWSSURL() {
			try {
				...
				if (this.autoReconnectEnabled && isRecoverable) return await this.delayReconnectAttempt(this.retrieveWSSURL);
				throw error;
			}
		}
		/**
...
var require_dist = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	exports.types = __importStar(require_dist$5());
	exports.webApi = __importStar(require_dist$4());
}));
//#endregion
...
function loadSlashCommandsRuntime() {
	slashCommandsRuntimePromise ??= import("./slash-commands.runtime-sc0tVdmR.js");
	return slashCommandsRuntimePromise;
}
function loadSlashDispatchRuntime() {
	slashDispatchRuntimePromise ??= import("./slash-dispatch.runtime-DfTg4TY1.js");
	return slashDispatchRuntimePromise;
}
function loadSlashSkillCommandsRuntime() {
	slashSkillCommandsRuntimePromise ??= import("./slash-skill-commands.runtime-BQbhgTbr.js");
