...
import { i as readSessionUpdatedAt } from "./store-_QDcIMYk.js";
...
import { $g as formatInboundEnvelope, Ag as recordChannelActivity, An as editMessageDiscord, By as EmbeddedBlockChunker, Cn as sendPollDiscord, En as sendWebhookMessageDiscord, Er as resolveTimestampMs, Gg as hasControlCommand, Gt as fetchPluralKitMessageInfo, Hg as resolveMentionGatingWithBypass, Jt as normalizeDiscordOutboundTarget, Pr as chunkDiscordTextWithMode, Sn as sendMessageDiscord, Tr as resolveDiscordSystemLocation, Ug as createChannelInboundDebouncer, Wg as shouldDebounceTextInbound, _i as Routes, _r as resolveDiscordMemberAccessState, br as resolveDiscordShouldRequireMention, c_ as dispatchInboundMessage, dr as isDiscordGroupAllowedByPolicy, gr as resolveDiscordGuildEntry, hr as resolveDiscordChannelConfigWithFallback, ib as resolveDiscordMaxLinesPerMessage, in as reactMessageDiscord, li as ChannelType, on as removeReactionDiscord, p_ as createReplyDispatcherWithTyping, pi as MessageType, pr as normalizeDiscordSlug, t_ as resolveEnvelopeFormatOptions, un as sendDiscordComponentMessage, vr as resolveDiscordOwnerAccess, wr as formatDiscordUserTag, xr as resolveGroupDmAllow, yn as buildDiscordInteractiveComponents } from "./pi-embedded-BTYL55uj.js";
import { t as buildAgentSessionKey } from "./resolve-route-jw3TrvbG.js";
import { r as resolveOutboundSendDep } from "./outbound-runtime-QVIwx-7l.js";
import { S as resolveTextChunkLimit, T as stripReasoningTagsFromText, u as convertMarkdownTables, x as resolveChunkMode } from "./text-runtime-BXjeqyjp.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-s6sZRjxj.js";
import { i as resolveOpenProviderRuntimeGroupPolicy } from "./runtime-group-policy-DqDSPQSR.js";
import { W as getSessionBindingService, c as ensureConfiguredBindingRouteReady, j as isPluginOwnedSessionBindingRecord, l as resolveConfiguredBindingRoute, s as recordInboundSession } from "./conversation-runtime-C56HP9yG.js";
import { i as createAttachedChannelResultAdapter, t as attachChannelToResult } from "./channel-send-result-DXTOPdrt.js";
...
import { b as sendTextMediaPayload, f as resolvePayloadMediaUrls, p as resolveSendableOutboundReplyParts, v as sendPayloadMediaSequenceOrFallback } from "./reply-payload-BTv3KfjW.js";
...
import { a as createStatusReactionController, d as logInboundDrop, f as logTypingFailure, r as DEFAULT_TIMING, u as logAckFailure } from "./channel-feedback-mKZrhk-A.js";
...
import { n as shouldAckReaction } from "./ack-reactions-Ds0XklR3.js";
import { c as createFinalizableDraftLifecycle, o as createRunStateMachine } from "./channel-lifecycle-CGlugnkL.js";
import { C as resolveDiscordMessageChannelId, E as resolveMediaList, S as resolveDiscordChannelInfo, T as resolveForwardedMediaList, _ as resolveDiscordWebhookId, a as handleDiscordDmCommandDecision, b as buildDiscordMediaPayload, c as resolveDiscordAutoThreadReplyPlan, d as resolveDiscordThreadStarter, f as deliverDiscordReply, g as resolveDiscordSenderIdentity, h as resolveReplyContext, i as resolveDiscordEffectiveRoute, l as resolveDiscordThreadChannel, m as buildGuildLabel, o as resolveDiscordDmCommandAccess, p as buildDirectLabel, r as resolveDiscordConversationRoute, s as sendTyping, t as buildDiscordRoutePeer, u as resolveDiscordThreadParentInfo, w as resolveDiscordMessageText, x as hasDiscordMessageStickers, y as buildDiscordInboundAccessContext } from "./route-resolution-CE9qizP3.js";
import { g as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.messages-B353uO4T.js";
import { a as runDiscordTaskWithTimeout, r as normalizeDiscordInboundWorkerTimeoutMs } from "./timeouts-B-MDqzYd.js";
import { l as getThreadBindingManager } from "./thread-bindings-ByKxs1P3.js";
...
async function resolveDiscordPreflightAudioMentionContext(params) {
	...
	if (needsPreflightTranscription) {
		...
		try {
			const { transcribeFirstAudio } = await import("./preflight-audio.runtime-CUYmA29Z.js");
			if (params.abortSignal?.aborted) return {
				hasAudioAttachment,
				hasTypedText
			};
