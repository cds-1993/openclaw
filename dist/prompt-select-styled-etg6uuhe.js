...
import { d as resolveProfileUnusableUntilForDisplay, h as repairOAuthProfileIdMismatch, m as resolveApiKeyForProfile } from "./auth-profiles-pjzxh_T1.js";
...
import { Ot as resolveNormalizedProviderModelMaxTokens, R as getTrustedSafeBinDirs, U as listRiskyConfiguredSafeBins, V as normalizeTrustedSafeBinDirs, d as readConfigFileSnapshot, g as writeConfigFile, it as resolveCommandResolutionFromArgv, jt as normalizeTalkSection, kt as DEFAULT_TALK_PROVIDER, z as isTrustedSafeBinPath } from "./io-CZZeeo8R.js";
...
import { n as parseToolsBySenderTypedKey, r as migrateLegacyConfig } from "./config-Bqe8DjNc.js";
import { t as describeUnknownError } from "./shared-B5oxOBg0.js";
import { c as ensureAuthProfileStore, m as updateAuthProfileStoreWithLock } from "./profiles-B_nscSgH.js";
...
import { n as loadSessionStore } from "./store-_QDcIMYk.js";
...
import { i as resolveAgentSessionDirs } from "./sessions-BwqyiEaq.js";
...
import { n as cleanStaleLockFiles } from "./session-write-lock-Db3SWNU3.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-BhjE3oIo.js";
import { f as printWizardHeader, m as randomToken, n as applyWizardMetadata, s as guardCancel } from "./onboard-helpers-Bv9rFhNK.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-b7s-IOwT.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-HkzccPBT.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-BZaBiFXI.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-KiKdTi2E.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-B3yeEL-n.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd-BFnmslpF.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-kgZC99GO.js";
...
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-Cz1nHB8a.js";
import { Cu as resolveCommandSecretRefsViaGateway, If as analyzeBootstrapBudget, Ih as listTelegramAccountIds, Lf as buildBootstrapInjectionStats, Ly as resolveBootstrapMaxChars, M as hasConfiguredMemorySecretInput, Nf as resolveBootstrapContextForRun, Ph as inspectTelegramAccount, Ry as resolveBootstrapTotalMaxChars, Uy as loadModelCatalog, ft as resolvePluginProviders, jh as lookupTelegramChatId, pt as loadOpenClawPlugins, yg as applyPluginAutoEnable, z as resolveApiKeyForProvider, zh as resolveTelegramAccount } from "./pi-embedded-BTYL55uj.js";
import { t as resolveMemorySearchConfig } from "./memory-search-C_KRQGyn.js";
import { i as listRouteBindings } from "./bindings-BSndXMZR.js";
import { a as formatSetExplicitDefaultToConfiguredInstruction, i as formatSetExplicitDefaultInstruction, r as formatChannelAccountsDefaultPath } from "./routing-GIGwPHsU.js";
import { D as resolveSandboxScope, M as DEFAULT_SANDBOX_BROWSER_IMAGE, P as DEFAULT_SANDBOX_IMAGE } from "./docker-Cq_Zfc99.js";
import { l as shouldMoveSingleAccountChannelKey } from "./setup-helpers-BHFbY0Qo.js";
import { a as readChannelAllowFromStore } from "./pairing-store-Bh2YkvRc.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-ChGQzSwJ.js";
import { C as parseBrowserMajorVersion, T as resolveGoogleChromeExecutableForPlatform, at as resolveConfiguredSecretInputWithFallback, w as readBrowserVersion } from "./routes-4Y7pr9vA.js";
import { n as logConfigUpdated } from "./logging-DFpZCDzJ.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./config-runtime-gAoemo4L.js";
import { t as collectProviderDangerousNameMatchingScopes } from "./dangerous-name-matching-TMkiuJ0K.js";
import { n as normalizeTelegramAllowFromEntry, t as isNumericTelegramUserId } from "./allow-from-DsA4ppPB.js";
import { a as listInterpreterLikeSafeBins, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-Di27nCtK.js";
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-wRPHRRib.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-D202yUGd.js";
import { a as detectLegacyMatrixState, i as autoMigrateLegacyMatrixState, n as hasPendingMatrixMigration, o as autoPrepareLegacyMatrixCrypto, r as maybeCreateMatrixMigrationSnapshot, s as detectLegacyMatrixCrypto, t as hasActionableMatrixMigration } from "./matrix-migration-snapshot-Brs5VDhy.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status--aw3byTK.js";
import { r as buildPluginCompatibilityWarnings } from "./status-DlXfYTpa.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DHXwi4sZ.js";
import { t as note$1 } from "./note-DBB81kon.js";
import { r as healthCommand } from "./health-Dq2NoQ3Q.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-CY6aE3Mj.js";
import { m as normalizeStoredCronJobs, n as runGatewayUpdate, t as runStartupMatrixMigration, v as detectPluginInstallPathIssue, y as formatPluginInstallPathIssue } from "./server-startup-matrix-migration-BEn8KKhz.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-Cu326U6i.js";
import { n as resolveProviderAuthLoginCommand, t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CzmJkVHY.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DWAhHSYn.js";
import { t as formatHealthCheckFailure } from "./health-format-B9VDAR0i.js";
import { n as doctorShellCompletion } from "./doctor-completion-CCAm8eA2.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BEpLL5lM.js";
import { a as isMattermostMutableAllowEntry, i as isMSTeamsMutableAllowEntry, n as isGoogleChatMutableAllowEntry, o as isSlackMutableAllowEntry, r as isIrcMutableAllowEntry, s as isZalouserMutableGroupEntry, t as isDiscordMutableAllowEntry } from "./mutable-allowlist-detectors-DmTNwwoY.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-3M2_zNZ3.js";
import { i as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./doctor-state-migrations-BA6Lf1KQ.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-BwkOmpQd.js";
