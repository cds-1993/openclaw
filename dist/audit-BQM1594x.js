...
import { U as listRiskyConfiguredSafeBins, V as normalizeTrustedSafeBinDirs } from "./io-CZZeeo8R.js";
...
import { l as isPrivateNetworkAllowedByPolicy, s as isBlockedHostnameOrIp } from "./ssrf-BifXvxQR.js";
import { n as resolveBrowserConfig, r as resolveProfile } from "./config-BnJ6TZJ3.js";
import { et as resolveBrowserControlAuth, f as redactCdpUrl } from "./routes-4Y7pr9vA.js";
import { i as loadExecApprovals } from "./exec-approvals-CFIa5yg0.js";
import { a as listInterpreterLikeSafeBins, r as isInterpreterLikeAllowlistPattern, s as resolveMergedSafeBinProfileFixtures } from "./exec-inline-eval-Di27nCtK.js";
import { n as hasPotentialConfiguredChannels } from "./config-presence-Cqse_N2e.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-CvbwRAyV.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-BgYYX1Km.js";
...
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-DybOQ9dz.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-CUuvHtfq.js");
	return await auditDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-BQ1C9lqt.js");
	return await auditChannelModulePromise;
}
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-DnRFCKUl.js"),
		import("./probe-auth-C3Cjwc3l.js"),
		import("./probe-LvV-Mnps.js")
