...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CFKaQcph.js";
import { t as sendMessageZalo } from "./send-H-ic2nJP.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DsIkEPGp.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-Ds4_5HUC.js");
