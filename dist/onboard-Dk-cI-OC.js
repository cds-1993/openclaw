...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-Bv9rFhNK.js";
...
import { t as runSetupWizard } from "./setup-ES3Rm06j.js";
import { i as resolveManifestProviderOnboardAuthFlags } from "./provider-auth-choices-KfbtiIS3.js";
import { n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-BWeUoc_J.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-Dz896bPR.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-C-N9SQxp.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-DK5Im_YD.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-C6VJiPJn.js");
