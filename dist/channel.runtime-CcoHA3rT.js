...
import { _ as normalizeAccountId, a as buildGroupHistoryKey, c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-DAhnzjyr.js";
...
import { A as resolveGroupSessionKey, a as recordSessionMetaFromInbound, c as updateLastRoute, n as loadSessionStore } from "./store-_QDcIMYk.js";
import { l as resolveStorePath } from "./paths-rhN9LKM_.js";
import { o as resolveIdentityNamePrefix, s as resolveMessagePrefix } from "./identity-D07jLUrU.js";
import { $g as formatInboundEnvelope, Ag as recordChannelActivity, At as resolveWhatsAppAuthDir, Bg as toLocationContext, D_ as resolveInboundDebounceMs, Dl as normalizeGroupActivation, Dt as listWhatsAppAccountIds, E_ as createInboundDebouncer, Gg as hasControlCommand, Jg as shouldComputeCommandAuthorized, Lt as readWebSelfId$1, Mt as getWebAuthAgeMs$1, Nt as logWebSelfId$1, Ol as parseActivationCommand, Pt as logoutWeb$1, Rg as resolveInboundSessionEnvelopeContext, Vg as resolveMentionGating, Vt as webAuthExists$1, Zc as getReplyFromConfig, _c as dispatchReplyWithBufferedBlockDispatcher, jt as resolveWhatsAppMediaMaxBytes, kt as resolveWhatsAppAccount, zg as formatLocationText } from "./pi-embedded-BTYL55uj.js";
...
import { S as resolveTextChunkLimit, l as markdownToWhatsApp, u as convertMarkdownTables, v as chunkMarkdownTextWithMode, x as resolveChunkMode } from "./text-runtime-BXjeqyjp.js";
import { a as hasAlphaChannel, c as resizeToJpeg, r as convertHeicToJpeg, s as optimizeImageToPng } from "./image-ops-339pOknK.js";
import { i as safeFileURLToPath, t as assertNoWindowsNetworkPath } from "./local-file-access-BdDE0bQ3.js";
import { n as extensionForMime, p as maxBytesForKind, s as kindFromMime, t as detectMime } from "./mime-C0asv0HQ.js";
import { a as migrateBaseNameToDefaultAccount, t as applyAccountNameToChannelSection } from "./setup-helpers-BHFbY0Qo.js";
...
import { c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-B2bSW_OI.js";
import { O as normalizeAllowFromEntries, rt as setSetupChannelEnabled, st as splitSetupEntries } from "./setup-wizard-proxy--gFyw5Eh.js";
import { a as resolveDmGroupAccessWithCommandGate, c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-ChGQzSwJ.js";
import { d as resolveOutboundMediaUrls, h as sendMediaWithLeadingCaption, p as resolveSendableOutboundReplyParts } from "./reply-payload-BTv3KfjW.js";
...
import { f as buildMentionRegexes, h as normalizeMentionText, r as buildHistoryContextFromEntries, u as recordPendingHistoryEntryIfEnabled } from "./reply-history-yYXk1ivL.js";
import { f as computeBackoff, p as sleepWithAbort } from "./level-overrides-BtGuLyCH.js";
import { P as saveMediaBuffer } from "./routes-4Y7pr9vA.js";
...
import { i as assertLocalMediaAllowed, l as fetchRemoteMedia, o as getAgentScopedMediaLocalRoots, r as LocalMediaAccessError } from "./web-media-Bo_Nxwjv.js";
import { r as shouldAckReactionForWhatsApp } from "./ack-reactions-Ds0XklR3.js";
import { t as waitForever } from "./cli-runtime-CYhFvgcO.js";
import { n as createConnectedChannelStatusPatch } from "./gateway-runtime-Czf7LoCY.js";
import { a as getStatusCode, c as getContentType, d as DisconnectReason, i as formatError, l as normalizeMessageContent, n as waitForCredsSaveQueueWithTimeout, o as downloadMediaMessage, r as waitForWaConnection, s as extractMessageContent, t as createWaSocket, u as isJidGroup } from "./session-uT9S21q_.js";
...
function getActiveWebListener$1(accountId) {
	const id = resolveWebAccountId(accountId);
...
function loadWhatsAppLoginQr() {
	loginQrPromise ??= import("./login-qr-C9sff1qE.js");
...
//#endregion
export { logoutWeb as a, startWebLoginWithQr as c, whatsappSetupWizard as d, whatsappSetupAdapter as f, loginWeb as i, waitForWebLogin as l, getWebAuthAgeMs as n, monitorWebChannel as o, logWebSelfId as r, readWebSelfId as s, getActiveWebListener as t, webAuthExists as u };
