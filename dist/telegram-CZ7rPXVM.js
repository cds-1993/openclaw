...
import { Bv as createAllowlistProviderRouteAllowlistWarningCollector, C as monitorTelegramProvider, Ch as isTelegramExecApprovalClientEnabled, Cm as sendTypingTelegram, Dh as listTelegramDirectoryGroupsFromConfig, E as buildTelegramExecApprovalButtons, G_ as createChatChannelPlugin, Ih as listTelegramAccountIds, K_ as defineChannelPluginEntry, Oh as listTelegramDirectoryPeersFromConfig, S as probeTelegram, Th as parseTelegramTarget, bg as buildExecApprovalPendingReplyPayload, bh as resolveTelegramGroupToolPolicy, dh as looksLikeTelegramTargetId, dm as sendTelegramPayloadMessages, fh as normalizeTelegramMessagingTarget, il as parseTelegramTopicConversation, kh as buildTelegramGroupPeerId, lh as parseTelegramReplyToMessageId, nm as collectTelegramStatusIssues, uh as parseTelegramThreadId, wg as resolveExecApprovalCommandDisplay, wh as resolveTelegramExecApprovalTarget, yh as resolveTelegramGroupRequireMention, zh as resolveTelegramAccount } from "./pi-embedded-BTYL55uj.js";
...
import { t as attachChannelToResult } from "./channel-send-result-DXTOPdrt.js";
...
import { a as resolveConfiguredFromCredentialStatuses, r as projectCredentialSnapshotFields } from "./account-snapshot-fields-B8GpE1Sm.js";
import { n as collectTelegramUnmentionedGroupIds, t as auditTelegramGroupMembership } from "./audit-D2IPvzYm.js";
import { t as createPluginRuntimeStore } from "./runtime-store-krvAWvNP.js";
import { c as createNestedAllowlistOverrideResolver, n as buildDmGroupAccountAllowlistAdapter } from "./allowlist-config-edit-C1utgEns.js";
import { a as telegramSetupWizard, i as telegramConfigAdapter, n as findTelegramTokenOwnerAccountId, o as telegramSetupAdapter, r as formatDuplicateTelegramTokenReason, t as createTelegramPluginBase } from "./shared-D2riohuY.js";
		...
		lifecycle: {
			onAccountConfigChanged: async ({ prevCfg, nextCfg, accountId }) => {
				if (resolveTelegramAccount({
					...
					const { deleteTelegramUpdateOffset } = await import("./update-offset-store-CUZo22fG.js");
