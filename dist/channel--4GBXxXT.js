...
import { G_ as createChatChannelPlugin, J_ as stripChannelTargetPrefix, Jv as projectConfigWarningCollector, Lv as createAllowlistProviderGroupPolicyWarningCollector, U_ as buildChannelOutboundSessionRoute, Y_ as stripTargetKindPrefix, av as createTopLevelChannelConfigAdapter, j_ as formatAllowFromLowercase } from "./pi-embedded-BTYL55uj.js";
...
const loadMSTeamsChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DhXoKd_k.js"), "msTeamsChannelRuntime");
...
const msteamsPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorMSTeamsProvider } = await import("./src-TgrWcOqb.js");
