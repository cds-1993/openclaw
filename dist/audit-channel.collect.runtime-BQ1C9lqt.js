...
const loadAuditChannelDiscordRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.discord.runtime-U5Ws8yX-.js"), ({ auditChannelDiscordRuntime }) => auditChannelDiscordRuntime);
const loadAuditChannelAllowFromRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.allow-from.runtime-CB4qoqtX.js"), ({ auditChannelAllowFromRuntime }) => auditChannelAllowFromRuntime);
const loadAuditChannelTelegramRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.telegram.runtime-DM4zmYCq.js"), ({ auditChannelTelegramRuntime }) => auditChannelTelegramRuntime);
const loadAuditChannelZalouserRuntimeModule = createLazyRuntimeSurface(() => import("./audit-channel.zalouser.runtime-C-R5jPEp.js"), ({ auditChannelZalouserRuntime }) => auditChannelZalouserRuntime);
