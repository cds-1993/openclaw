import { r as fileExists } from "./archive-Df6iZdzY.js";
import { c as resolveClawHubBaseUrl, f as searchClawHubSkills, o as fetchClawHubSkillDetail, r as downloadClawHubSkillArchive } from "./clawhub-C7cd_hWw.js";
import { n as resolveSafeInstallDir } from "./install-safe-path-ByJx0qrH.js";
import { i as withExtractedArchiveRoot, t as installPackageDir } from "./install-package-dir-BX16jggU.js";
...
function normalizeSlug(raw) {
	...
	if (!trimmed || trimmed.includes("/") || trimmed.includes("\\") || trimmed.includes("..")) throw new Error(`Invalid skill slug: ${raw}`);
	return trimmed;
}
