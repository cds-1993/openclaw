...
import { a as clearExpiredCooldowns, f as resolveProfilesUnavailableReason, s as isProfileInCooldown } from "./auth-profiles-pjzxh_T1.js";
...
import { r as withFileLock } from "./file-lock-BJsnXQjL.js";
import { c as ensureAuthProfileStore } from "./profiles-B_nscSgH.js";
import { l as normalizeMessageChannel } from "./message-channel-BliByQBl.js";
import { i as readSessionUpdatedAt, l as updateSessionStore, n as loadSessionStore } from "./store-_QDcIMYk.js";
...
import { i as resolveHumanDelayConfig } from "./identity-D07jLUrU.js";
import { $g as formatInboundEnvelope, $r as UserSelectMenu, Br as GuildDeleteListener, Cr as formatDiscordReactionEmoji, Dn as formatMention, Fr as Separator, Gp as matchPluginCommand, Gr as PresenceUpdateListener, H_ as summarizeMapping, Hr as MessageCreateListener, Ir as TextDisplay, Jr as VoiceServerUpdateListener, Kr as ReadyListener, L_ as addAllowlistUserEntriesFromConfigEntry, Lg as resolveNativeCommandSessionTargets, Lr as Container, Pr as chunkDiscordTextWithMode, Qr as RateLimitError, R_ as buildAllowlistResolutionSummary, Rr as Row, Sa as buildModelsProviderData, Sg as getExecApprovalApproverDmNoticeText, Sr as shouldEmitDiscordReactionNotification, Up as executePluginCommand, Ur as MessageReactionAddListener, V_ as patchAllowlistUsersInConfigEntries, Vr as InteractionCreateListener, Wr as MessageReactionRemoveListener, Xr as ListenerEvent, Yr as VoiceStateUpdateListener, Zp as getPluginCommandSpecs, Zr as Client, _c as dispatchReplyWithBufferedBlockDispatcher, _i as Routes, _n as parseDiscordModalCustomIdForCarbon, _r as resolveDiscordMemberAccessState, ab as normalizeDiscordToken, ai as ChannelSelectMenu, bi as setPresence, bn as resolveDiscordComponentEntry, ci as serializePayload, cn as editDiscordComponentMessage, di as GatewayIntentBits, dr as isDiscordGroupAllowedByPolicy, ei as StringSelectMenu, fg as wrapFetchWithAbortSignal, fi as GatewayOpcodes$1, fn as createDiscordFormModal, fr as normalizeDiscordAllowList, gc as createReplyReferencePlanner, gi as ChannelType$1, gn as parseDiscordModalCustomId, gr as resolveDiscordGuildEntry, hi as ButtonStyle, hn as parseDiscordComponentCustomIdForCarbon, hr as resolveDiscordChannelConfigWithFallback, ib as resolveDiscordMaxLinesPerMessage, ii as Command, jr as createDiscordClient, li as ChannelType, mi as ApplicationCommandOptionType, mn as parseDiscordComponentCustomId, mr as resolveDiscordAllowListMatch, nb as resolveDiscordAccount, ni as MentionableSelectMenu, nn as unregisterGateway, oi as Button, or as stripUndefinedFields, pn as formatDiscordComponentEventText, pr as normalizeDiscordSlug, qr as ThreadUpdateListener, ri as CommandWithSubcommands, si as Plugin, t_ as resolveEnvelopeFormatOptions, ti as RoleSelectMenu, tn as registerGateway, ui as GatewayCloseCodes$1, vc as dispatchReplyWithDispatcher, vr as resolveDiscordOwnerAccess, wg as resolveExecApprovalCommandDisplay, wr as formatDiscordUserTag, wt as dispatchPluginInteractiveHandler, xn as resolveDiscordModalEntry, xr as resolveGroupDmAllow, z_ as canonicalizeAllowlistWithResolvedIds, zr as Modal } from "./pi-embedded-BTYL55uj.js";
import { i as resolveAgentRoute } from "./resolve-route-jw3TrvbG.js";
import { S as resolveTextChunkLimit, r as chunkItems, t as withTimeout, w as summarizeStringEntries, x as resolveChunkMode } from "./text-runtime-BXjeqyjp.js";
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-DqDSPQSR.js";
import { F as resolvePluginConversationBindingApproval, N as parsePluginBindingApprovalCustomId, T as buildPluginBindingResolvedText, c as ensureConfiguredBindingRouteReady, l as resolveConfiguredBindingRoute, s as recordInboundSession, t as formatThreadBindingDurationLabel } from "./conversation-runtime-C56HP9yG.js";
...
import { c as resolvePinnedMainDmOwnerFromAllowlist, l as resolveCommandAuthorizedFromAuthorizers, n as readStoreAllowFromForDmPolicy, o as resolveDmGroupAccessWithLists } from "./dm-policy-shared-ChGQzSwJ.js";
import { m as resolveTextChunksWithFallback, p as resolveSendableOutboundReplyParts } from "./reply-payload-BTv3KfjW.js";
...
import { c as listChatCommands, d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, h as resolveCommandArgChoices, m as parseCommandArgs, n as buildCommandTextFromArgs, r as findCommandByNativeName, v as serializeCommandArgs } from "./commands-registry-ABOHrld2.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-I_17sL0j.js";
import { o as resolveStoredModelOverride } from "./level-overrides-BtGuLyCH.js";
import { l as resolveMarkdownTableMode } from "./config-runtime-gAoemo4L.js";
import { n as isDangerousNameMatchingEnabled } from "./dangerous-name-matching-TMkiuJ0K.js";
import { i as formatDurationSeconds } from "./format-duration-gUgoY3JD.js";
import { r as enqueueSystemEvent } from "./system-events-C2ngfmKm.js";
import { t as require_src } from "./src-DL4DB9lB.js";
import { o as getAgentScopedMediaLocalRoots, t as loadWebMedia } from "./web-media-Bo_Nxwjv.js";
import { n as createConnectedChannelStatusPatch, t as createOperatorApprovalsGatewayClient } from "./gateway-runtime-Czf7LoCY.js";
import { a as createArmableStallWatchdog } from "./channel-lifecycle-CGlugnkL.js";
import { S as resolveDiscordChannelInfo, a as handleDiscordDmCommandDecision, f as deliverDiscordReply, g as resolveDiscordSenderIdentity, i as resolveDiscordEffectiveRoute, m as buildGuildLabel, n as resolveDiscordBoundConversationRoute, o as resolveDiscordDmCommandAccess, p as buildDirectLabel, s as sendTyping, u as resolveDiscordThreadParentInfo, v as buildDiscordGroupSystemPrompt, y as buildDiscordInboundAccessContext } from "./route-resolution-CE9qizP3.js";
import { a as isThreadArchived } from "./thread-bindings.messages-B353uO4T.js";
import { a as runDiscordTaskWithTimeout, i as normalizeDiscordListenerTimeoutMs } from "./timeouts-B-MDqzYd.js";
import { n as fetchDiscordApplicationId, t as DiscordUiContainer } from "./ui-FhcTyl5y.js";
import { t as resolveDiscordUserAllowlist } from "./resolve-users-B3IQ6fxI.js";
import { t as resolveDiscordChannelAllowlist } from "./resolve-channels-BEDNRvn6.js";
...
async function loadDiscordVoiceRuntime() {
	discordVoiceRuntimePromise ??= import("./manager.runtime-C8XEdDA8.js");
	return await discordVoiceRuntimePromise;
}
async function loadDiscordProviderSessionRuntime() {
	discordProviderSessionRuntimePromise ??= import("./provider-session.runtime-ChWt5p-B.js");
