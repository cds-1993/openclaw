...
import { T as resolveAuthProfileDisplayLabel, d as resolveProfileUnusableUntilForDisplay, i as clearAuthProfileCooldown, n as resolveAuthProfileOrder, t as resolveAuthProfileEligibility } from "./auth-profiles-pjzxh_T1.js";
...
import { f as readConfigFileSnapshotForWrite, i as createConfigIO, m as setRuntimeConfigSnapshot, s as loadConfig } from "./io-CZZeeo8R.js";
...
import { a as upsertAuthProfile, c as ensureAuthProfileStore, i as setAuthProfileOrder, n as listProfilesForProvider, u as loadAuthProfileStoreForRuntime } from "./profiles-B_nscSgH.js";
...
import { d as openUrl } from "./onboard-helpers-Bv9rFhNK.js";
import { r as isWSLEnv } from "./wsl-b7s-IOwT.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-HkzccPBT.js";
import { r as withProgressTotals } from "./progress-DlclNKc3.js";
import { B as resolveAwsSdkEnvVarName, Cu as resolveCommandSecretRefsViaGateway, F as getCustomProviderApiKey, H as resolveUsableCustomProviderApiKey, L as hasUsableCustomProviderApiKey, Ou as describeFailoverError, Rp as resolveModelWithRegistry, Uy as loadModelCatalog, ft as resolvePluginProviders, go as loadProviderUsageSummary, t as runEmbeddedPiAgent, yo as formatUsageWindowSummary, z as resolveApiKeyForProvider, zp as shouldSuppressBuiltInModel } from "./pi-embedded-BTYL55uj.js";
import { c as resolveEnvApiKey, y as isNonSecretApiKeyMarker } from "./provider-auth-input-WYCWu6tD.js";
import { n as logConfigUpdated } from "./logging-DFpZCDzJ.js";
import { S as upsertCanonicalModelConfigEntry, _ as normalizeAlias, b as resolveModelTarget, d as ensureFlagCompatibility, f as formatMs, g as mergePrimaryFallbackConfig, h as loadValidConfigOrThrow, m as isLocalBaseUrl, p as formatTokenK, u as applyDefaultModelPrimaryUpdate, v as resolveKnownAgentId, x as updateConfig, y as resolveModelKeysFromEntries } from "./config-runtime-gAoemo4L.js";
...
import { m as resolveUsageProviderId } from "./provider-usage-qQL8PJ0p.js";
import { i as getModelsCommandSecretTargetIds } from "./command-secret-targets-wRPHRRib.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-DHXwi4sZ.js";
import { t as maskApiKey } from "./mask-api-key-GWdIdLxJ.js";
...
import { n as redactSecrets } from "./format-CGvOql3u.js";
import { t as createVpsAwareOAuthHandlers } from "./provider-oauth-flow-BtBOQ8Wy.js";
import { i as resolveProviderMatch, n as mergeConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-Dx0GKO_a.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-CzmJkVHY.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BYXSL_40.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-D4U6kbbb.js");
	const { ensureOpenClawModelsJson } = await import("./models-config-BMZC6upK.js");
