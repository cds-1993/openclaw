...
import { t as require_content_type } from "./content-type-BxWyl39v.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-CH8rCeqg.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-DZrr2ucU.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-4bRPqgz0.js";
import { l as toRatio, n as decodeString } from "./Util-CM9UWlb3.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-BJJXUoVO.js";
import { t as APEv2Parser } from "./APEv2Parser-BVdB7XgU.js";
import { r as hasID3v1Header } from "./ID3v1Parser-B9S6iwGn.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-BtqUp0Mm.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DiFTnNqd.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DuHeARS1.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-BJem_tVc.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-d2pZi2lg.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-DTLNBFSn.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-67UyLyzt.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-CVTLwOJu.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-a9FnQFVS.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-Bd8TTIQo.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-CfNb9pj5.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DwzHGnO5.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DCYp9Iwo.js")).WaveParser;
	}
};
//#endregion
