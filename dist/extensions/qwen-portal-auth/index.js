...
import { l as QWEN_PORTAL_BASE_URL, u as buildQwenPortalProvider } from "../../provider-catalog-BGWDC_kb.js";
...
import { t as refreshQwenPortalCredentials } from "../../runtime-api-DZXOSUD4.js";
		...
		api.registerProvider({
			...
			auth: [{
				...
				run: async (ctx) => {
					...
					try {
						const { loginQwenPortalOAuth } = await import("../../oauth.runtime-CQ3San3D.js");
