...
import { F as readRequestBodyWithLimit, I as requestBodyErrorToText, N as isRequestBodyLimitError, h as WEBHOOK_BODY_READ_DEFAULTS, y as createWebhookInFlightLimiter } from "../../webhook-ingress-BBdXea0x.js";
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("../../response-generator-C5SPEheX.js");
