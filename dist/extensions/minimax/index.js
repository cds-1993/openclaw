...
import { Wh as buildOauthProviderAuthResult } from "../../pi-embedded-BTYL55uj.js";
import "../../internal-hooks-ClBId-OS.js";
import "../../multimodal-rLHaC7mC.js";
import "../../memory-search-C_KRQGyn.js";
import { C as buildMinimaxPortalProvider, w as buildMinimaxProvider } from "../../provider-catalog-BGWDC_kb.js";
...
import { o as isMiniMaxModernModelId, r as MINIMAX_TEXT_MODEL_CATALOG, t as MINIMAX_DEFAULT_MODEL_ID } from "../../provider-model-minimax-CYJqVplI.js";
...
import { a as describeImagesWithModel, i as describeImageWithModel } from "../../media-understanding-DqfP3p8W.js";
...
import { n as fetchMinimaxUsage } from "../../provider-usage-qQL8PJ0p.js";
import { n as applyOnboardAuthAgentModelsAndProviders, t as applyAgentDefaultModelPrimary } from "../../provider-onboarding-config-ICH5iU24.js";
...
function createOAuthHandler(region) {
	...
	return async (ctx) => {
		...
		try {
			const { loginMiniMaxPortalOAuth } = await import("../../oauth.runtime-Dhi9OA6Y.js");
