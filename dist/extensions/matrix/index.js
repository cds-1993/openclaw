...
import { a as getMatrixRuntime, o as setMatrixRuntime } from "../../credentials-read-C82dg7Ru.js";
import { $ as updateMatrixAccountConfig, J as setMatrixSdkLogMode, L as resolveMatrixAccount, Q as resolveMatrixConfigPath, R as resolveMatrixAccountConfig, W as resolveMatrixAuthContext, X as resolveMatrixRoomKeyBackupIssue, c as repairMatrixDirectRooms, q as setMatrixSdkConsoleLogging, s as inspectMatrixDirectRooms } from "../../send-ErlDppBV.js";
import "../../types-DktLAfVh.js";
import { n as matrixSetupAdapter, r as maybeBootstrapNewEncryptedMatrixAccount, t as matrixPlugin } from "../../channel-CMznzYlA.js";
import "../../allowlist-CDmlbdAB.js";
import "../../encryption-guidance-C-ZJtdB8.js";
import "../../lib-CH8rCeqg.js";
import "../../BasicParser-4bRPqgz0.js";
import { c as getMatrixRoomKeyBackupStatus, h as restoreMatrixRoomKeyBackup, m as resetMatrixRoomKeyBackup, n as bootstrapMatrixVerification, u as getMatrixVerificationStatus, v as verifyMatrixRecoveryKey, x as withStartedActionClient, y as withResolvedActionClient } from "../../verification-CR1j0AGM.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "../../profile-update-DDS0lNat.js";
...
var matrix_default = defineChannelPluginEntry({
	...
	registerFull(api) {
		import("../../plugin-entry.runtime-Du5hr4xq.js").then(({ ensureMatrixCryptoRuntime }) => ensureMatrixCryptoRuntime({ log: api.logger.info }).catch((err) => {
		...
		api.registerGatewayMethod("matrix.verify.recoveryKey", async (ctx) => {
			const { handleVerifyRecoveryKey } = await import("../../plugin-entry.runtime-Du5hr4xq.js");
			await handleVerifyRecoveryKey(ctx);
		});
		api.registerGatewayMethod("matrix.verify.bootstrap", async (ctx) => {
			const { handleVerificationBootstrap } = await import("../../plugin-entry.runtime-Du5hr4xq.js");
			await handleVerificationBootstrap(ctx);
		});
		api.registerGatewayMethod("matrix.verify.status", async (ctx) => {
			const { handleVerificationStatus } = await import("../../plugin-entry.runtime-Du5hr4xq.js");
