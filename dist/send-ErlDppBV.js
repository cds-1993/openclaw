...
import { Ht as listConfiguredAccountIds } from "./pi-embedded-BTYL55uj.js";
import { o as resolveMergedAccountConfig } from "./account-helpers-BiC682rw.js";
import { o as isAutoLinkedFileRef } from "./text-runtime-BXjeqyjp.js";
import { d as resolvePinnedHostnameWithPolicy, i as createPinnedDispatcher, r as closeDispatcher } from "./ssrf-BifXvxQR.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-s6sZRjxj.js";
import { n as writeJsonFileAtomically } from "./json-store-BIglSbRG.js";
import { a as ssrfPolicyFromAllowPrivateNetwork, t as assertHttpUrlTargetsPrivateNetwork } from "./ssrf-policy-BlgZt63j.js";
import { n as normalizePollInput } from "./polls-GziVvR8X.js";
import { C as resolveMatrixDefaultOrOnlyAccountId, T as resolveMatrixAccountStringValues, b as requiresExplicitMatrixDefaultAccount, h as resolveMatrixAccountStorageRoot, v as resolveMatrixLegacyFlatStoragePaths, w as getMatrixScopedEnvVarNames, x as resolveConfiguredMatrixAccountIds } from "./matrix-B19qBU9f.js";
import { r as maybeCreateMatrixMigrationSnapshot } from "./matrix-migration-snapshot-Brs5VDhy.js";
import { a as getMatrixRuntime, n as loadMatrixCredentials, t as credentialsMatchConfig } from "./credentials-read-C82dg7Ru.js";
import { $ as MapWithDefault, A as VerifierEvent, E as decodeRecoveryKey, N as Preset, O as VerificationPhase, U as KnownMembership, V as UNREAD_THREAD_NOTIFICATIONS, W as EventType$1, Y as logger, Z as MemoryCryptoStore, a as RoomStateEvent, ct as require_asyncToGenerator, et as deepCopy, it as recursiveMapToObject, j as MatrixScheduler, k as VerificationRequestEvent, l as ClientEvent, nt as isSupportedReceiptType, o as MAX_STICKY_DURATION_MS, ot as UnstableValue, q as TypedEventEmitter, s as MatrixEventEvent, st as require_defineProperty, t as VerificationMethod, u as MatrixClient$1, w as CryptoEvent } from "./types-DktLAfVh.js";
import { r as parseBuffer } from "./lib-CUE8eqIU.js";
...
async function loadMatrixCryptoNodeRuntime() {
	matrixCryptoNodeRuntimePromise ??= import("./crypto-node.runtime-DUeRXpBk.js");
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-HtVZGNTZ.js");
...
//#endregion
export { updateMatrixAccountConfig as $, normalizeMatrixMessagingTarget as A, resolveSharedMatrixClient as B, isPollStartType as C, withResolvedRuntimeMatrixClient as D, resolvePollReferenceEventId as E, resolveConfiguredMatrixBotUserIds as F, resolveMatrixEnvAuthReadiness as G, resolveMatrixStoragePaths as H, resolveDefaultMatrixAccountId as I, setMatrixSdkLogMode as J, MatrixAuthedHttpClient as K, resolveMatrixAccount as L, resolveMatrixDirectUserId as M, resolveMatrixTargetIdentity as N, setActiveMatrixClient as O, listMatrixAccountIds as P, resolveMatrixConfigPath as Q, resolveMatrixAccountConfig as R, isPollEventType as S, parsePollStartContent as T, resolveMatrixAuth as U, createMatrixClient as V, resolveMatrixAuthContext as W, resolveMatrixRoomKeyBackupIssue as X, LogService as Y, resolveMatrixConfigFieldPath as Z, summarizeMatrixReactionEvents as _, sendTypingMatrix as a, formatPollAsText as b, repairMatrixDirectRooms as c, readJoinedMatrixMembers as d, isBunRuntime as et, MATRIX_ANNOTATION_RELATION_TYPE as f, selectOwnMatrixReactionEventIds as g, extractMatrixReactionAnnotation as h, sendReadReceiptMatrix as i, normalizeMatrixResolvableTarget as j, isMatrixQualifiedUserId as k, isStrictDirectMembership as l, buildMatrixReactionRelationsPath as m, sendMessageMatrix as n, resolveMatrixRoomId as o, MATRIX_REACTION_EVENT_TYPE as p, setMatrixSdkConsoleLogging as q, sendPollMatrix as r, inspectMatrixDirectRooms as s, reactMatrixMessage as t, hasExplicitMatrixAccountConfig as tt, isStrictDirectRoom as u, buildPollResponseContent as v, parsePollStart as w, formatPollResultsAsText as x, buildPollResultsSummary as y, releaseSharedClientInstance as z };
