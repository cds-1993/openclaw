...
import { Cu as resolveCommandSecretRefsViaGateway, _o as formatUsageReportLines, _u as resolveMessageChannelSelection, af as resolveMessageActionDiscoveryForPlugin, go as loadProviderUsageSummary, if as createMessageActionDiscoveryContext } from "./pi-embedded-BTYL55uj.js";
...
import { r as listChannelPluginCatalogEntries } from "./catalog-BiNXlhWs.js";
import "./note-DBB81kon.js";
import { t as createClackPrompter } from "./clack-prompter-DF9Cr-px.js";
import "./plugin-install-plan-K0Zu7uy6.js";
import "./bundled-sources-C3dvoiym.js";
import "./plugin-install-AEQQ2S-y.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-CzsK7XDr.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-Bzft8nm5.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-Cu326U6i.js";
import { t as parseLogLine } from "./parse-log-line-m5Js2Q4g.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-aM12SwnZ.js";
import { a as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks, t as createChannelOnboardingPostWriteHookCollector } from "./onboard-channels-n5sx6Nn1.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-DS06cduD.js"), import("./onboard-channels-CE7rQgOV.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-DjFwpfhl.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-DjFwpfhl.js");
			const prompter = createClackPrompter();
