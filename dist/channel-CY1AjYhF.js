...
import { $_ as createHybridChannelConfigAdapter, G_ as createChatChannelPlugin, J_ as stripChannelTargetPrefix, Lv as createAllowlistProviderGroupPolicyWarningCollector, Q_ as adaptScopedAccountAccessor, U_ as buildChannelOutboundSessionRoute, j_ as formatAllowFromLowercase, qv as projectConfigAccountIdWarningCollector } from "./pi-embedded-BTYL55uj.js";
...
import { i as createActionGate } from "./common-DArxwyX8.js";
...
import { _ as feishuSetupAdapter, a as feishuSetupWizard, c as createFeishuClient, f as listEnabledFeishuAccounts, g as resolveFeishuCredentials, h as resolveFeishuAccount, i as parseFeishuConversationId, m as resolveDefaultFeishuAccountId, p as listFeishuAccountIds } from "./feishu-CvdeBW0z.js";
import { i as normalizeFeishuTarget, r as looksLikeFeishuId, t as getFeishuRuntime } from "./runtime-b_hauYqw.js";
import { n as listFeishuDirectoryPeers, t as listFeishuDirectoryGroups } from "./directory.static-Do72yIIr.js";
import { i as resolveFeishuGroupToolPolicy } from "./policy-D7ft37Dw.js";
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-Dc6HyCBI.js"), "feishuChannelRuntime");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BDGwsaek.js");
			const account = resolveFeishuAccount({
				cfg: ctx.cfg,
