...
import { d as readConfigFileSnapshot, g as writeConfigFile, v as validateConfigObjectRaw } from "./io-CZZeeo8R.js";
...
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-C8oDJazD.js";
import { t as OLLAMA_DEFAULT_BASE_URL } from "./ollama-defaults-DIsqM-W5.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-CofRQwTE.js";
import "./timeouts-B-MDqzYd.js";
import "./timeouts-Dkn-AWOO.js";
import { t as redactConfigObject } from "./redact-snapshot-ThFQ5Sbe.js";
import { n as setCommandJsonMode } from "./json-mode-CoOhGnPY.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-IqfsVtX9.js");
