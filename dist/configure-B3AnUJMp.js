...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, g as resolveControlUiLinks, m as randomToken, n as applyWizardMetadata, p as probeGatewayReachable, s as guardCancel, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput, v as summarizeExistingConfig, y as validateGatewayPasswordInput } from "./onboard-helpers-Bv9rFhNK.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-BFnmslpF.js";
import { n as withProgress } from "./progress-DlclNKc3.js";
import { ft as resolvePluginProviders } from "./pi-embedded-BTYL55uj.js";
import { n as applyPrimaryModel } from "./provider-model-primary-LkrdNZXt.js";
...
import { n as resolveProviderPluginChoice } from "./provider-wizard-CnqJaHtL.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-DjYwO6lZ.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-BeUaDeFa.js";
import { n as applyAuthChoice } from "./auth-choice-BbJxM-Fc.js";
import { i as setupChannels, n as noteChannelStatus } from "./onboard-channels-n5sx6Nn1.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DWAhHSYn.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-xag3A6GR.js";
import { i as promptCustomApiConfig } from "./onboard-custom-B0097PTt.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-B1Rh4rtT.js";
import { t as formatHealthCheckFailure } from "./health-format-B9VDAR0i.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-BLTbiaj0.js";
import { t as setupSkills } from "./onboard-skills-BmZMg6lv.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { resolveSearchProviderOptions, resolveExistingKey, hasExistingKey, applySearchKey, applySearchProviderSelection, hasKeyInEnv } = await import("./onboard-search-C8jdFq7J.js");
