...
import { d as readConfigFileSnapshot, x as OpenClawSchema } from "./io-CZZeeo8R.js";
import { n as formatConfigIssueLines } from "./issue-format-C8oDJazD.js";
import { t as note } from "./note-DBB81kon.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-CrbVUTZF.js");
