...
import { a as getRuntimeConfigSnapshot, g as writeConfigFile, i as createConfigIO, s as loadConfig } from "./io-CZZeeo8R.js";
...
import { r as ensurePortAvailable } from "./ports-B3yeEL-n.js";
import { t as generateSecureToken } from "./secure-random-Dgumttcn.js";
import { c as resizeToJpeg, i as getImageMetadata, n as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-339pOknK.js";
import { n as extensionForMime, t as detectMime } from "./mime-C0asv0HQ.js";
import { r as hasProxyEnvConfigured } from "./proxy-env-Bp6SXFEY.js";
import { d as resolvePinnedHostnameWithPolicy, l as isPrivateNetworkAllowedByPolicy, t as SsrFBlockedError, u as resolvePinnedHostname } from "./ssrf-BifXvxQR.js";
import { a as openFileWithinRoot, c as readLocalFileSafely, t as SafeOpenError } from "./fs-safe-B2bSW_OI.js";
import { a as allocateColor, c as isValidProfileName, d as DEFAULT_AI_SNAPSHOT_MAX_CHARS, i as allocateCdpPort, l as deriveDefaultBrowserCdpPortRange, n as resolveBrowserConfig, o as getUsedColors, p as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, r as resolveProfile, s as getUsedPorts, t as parseHttpUrl, u as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./config-BnJ6TZJ3.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CC0-tsCd.js");
	} catch (err) {
...
function createProfileAvailability({ opts, profile, state, getProfileState, setProfileRunning }) {
	...
	const closePlaywrightBrowserConnectionForProfile = async (cdpUrl) => {
		try {
			await (await import("./pw-ai-CC0-tsCd.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
		} catch {}
	};
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-CC0-tsCd.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
