...
import { t as registerMemoryCli } from "./memory-cli-ity8006B.js";
...
import { $g as formatInboundEnvelope, Ag as recordChannelActivity, Bi as buildTemplateMessageFromPayload, D as telegramMessageActions, D_ as resolveInboundDebounceMs, Du as listRuntimeImageGenerationProviders, E_ as createInboundDebouncer, Eu as generateImage, Gg as hasControlCommand, Jg as shouldComputeCommandAuthorized, Li as probeLineBot, Qg as formatAgentEnvelope, Sf as requestHeartbeatNow, T as setTelegramThreadBindingMaxAgeBySessionKey, Vh as resolveTelegramToken, Wc as onAgentEvent, Xa as runWebSearch, Ya as listWebSearchProviders, _c as dispatchReplyWithBufferedBlockDispatcher, aa as pushMessageLine, ca as pushTextMessageWithQuickReplies, cc as probeSignal, ch as isVoiceCompatibleAudio, d_ as withReplyDispatcher, da as normalizeAccountId, fa as resolveDefaultLineAccountId, h_ as dispatchReplyFromConfig, ia as pushLocationMessage, kg as getChannelActivity, kl as signalMessageActions, la as sendMessageLine, lc as monitorSignalProvider, na as createQuickReplyItems, oa as pushMessagesLine, p_ as createReplyDispatcherWithTyping, pa as resolveLineAccount, qg as isControlCommandMessage, ra as pushFlexMessage, sa as pushTemplateMessage, t_ as resolveEnvelopeFormatOptions, ua as listLineAccountIds, uc as sendMessageSignal, w as setTelegramThreadBindingIdleTimeoutBySessionKey, zi as monitorLineProvider } from "./pi-embedded-BTYL55uj.js";
...
import { n as collectTelegramUnmentionedGroupIds } from "./audit-D2IPvzYm.js";
import { t as discordMessageActions } from "./runtime-api-D0o3wbqi.js";
import { D as resolveThreadBindingMaxAgeExpiresAt, E as resolveThreadBindingInactivityExpiresAt, O as resolveThreadBindingMaxAgeMs, T as resolveThreadBindingIdleTimeoutMs } from "./thread-bindings.messages-B353uO4T.js";
import { a as setThreadBindingMaxAgeBySessionKey, i as setThreadBindingIdleTimeoutBySessionKey, l as getThreadBindingManager, o as unbindThreadBindingsBySessionKey } from "./thread-bindings-ByKxs1P3.js";
import { n as sendMessageIMessage, r as probeIMessage, t as monitorIMessageProvider } from "./imessage-CkIdpWbK.js";
...
const loadEmbeddedPiRuntime = createLazyRuntimeModule(() => import("./runtime-embedded-pi.runtime-BxXsBMiy.js"));
...
const bindDiscordRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-discord-ops.runtime-B-1R38g5.js"), ({ runtimeDiscordOps }) => runtimeDiscordOps));
...
const bindSlackRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-slack-ops.runtime-BmisYXq6.js"), ({ runtimeSlackOps }) => runtimeSlackOps));
...
const bindTelegramRuntimeMethod = createLazyRuntimeMethodBinder(createLazyRuntimeSurface(() => import("./runtime-telegram-ops.runtime-DGu8-u3x.js"), ({ runtimeTelegramOps }) => runtimeTelegramOps));
...
async function loadMemoryToolRuntime() {
	memoryToolRuntimePromise ??= import("./memory-tool.runtime-k1YbSmN-.js");
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("./runtime-tts.runtime-CCLPj9KT.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("./runtime-media-understanding.runtime-CaNJaXUD.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("./runtime-model-auth.runtime-DMjJCyOr.js"));
